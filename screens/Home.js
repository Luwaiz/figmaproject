...
const Home=({navigation})=>{
    ...
    const [Subtext1,setSubtext1]=useState("Place your order for exquisite menus and mouth")
  ...
  <View style={styles.widget}>
    <View style={styles.Widget1}></View><View style={styles.widget2}></View><View style={styles.widget3}></View>
  </View>
  <TouchableOpacity style={styles.button} onPress={NavigateToNext1}>
